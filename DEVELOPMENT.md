...
```bash
git remote add encore encore://fitness-health-tracker-5a9i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/fitness-health-tracker-5a9i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/fitness-health-tracker-5a9i/settings/integrations/github)
